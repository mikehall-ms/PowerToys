...
namespace powertoys_gpo
{
    ...
    const std::wstring POLICY_CONFIGURE_ENABLED_RIGHT_CLICK_LOCK = L"ConfigureEnabledUtilityRightClickLock";
...
#pragma region UtilityEnabledStatePolicies
    ...
    inline gpo_rule_configured_t getConfiguredRightClickLockEnabledValue()
    {
        return getUtilityEnabledValue(POLICY_CONFIGURE_ENABLED_RIGHT_CLICK_LOCK);
    }
